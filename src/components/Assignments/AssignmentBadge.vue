<template>
  ...
  <div class="flex flex-col items-center gap-1">
    <div class="relative w-10 h-10 sm:w-12 sm:h-12 rounded-full">
      <!-- Progress border -->
      <div
    ...
    <div class="text-center max-w-[70px]">
      <span class="text-[10px] sm:text-xs text-gray-300 truncate block">{{ displayName }}</span>
      <p class="text-[9px] sm:text-[10px] text-gray-500 truncate">{{ instrument }}</p>
    </div>
  </div>
</template>
